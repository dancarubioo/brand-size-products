...
<div id="sidebar">
    <ul>
        ...
        <li>
            <a href="add_new_unit.php"><i class="icon icon-user"></i><span>Add New Size</span></a>
        </li>

        <li>
            <a href="add_new_company.php"><i class="icon icon-user"></i><span>Add New Brand</span></a>
        </li>
